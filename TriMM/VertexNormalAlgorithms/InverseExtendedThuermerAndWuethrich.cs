...
namespace TriMM.VertexNormalAlgorithms {
    ...
    /// The facet normals are weighted by the angle of the adjacent Triangle and (in addition) the inverse of that Triangles area.
    /// </summary>
    internal class InverseExtendedThuermerAndWuethrich : IVertexNormalAlgorithm {
        ...
        public string Name { get { return "Inverse Extended ThuermerAndWuethrich"; } }
        ...
        /// weighted by the angle between the neighboring Vertices and the inverse of that Triangles area.
        /// </summary>
