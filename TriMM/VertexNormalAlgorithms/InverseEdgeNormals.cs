...
namespace TriMM.VertexNormalAlgorithms {
    ...
    public class InverseEdgeNormals : IVertexNormalAlgorithm {
        ...
        public string Name { get { return TriMMApp.Lang.GetElementsByTagName("IEN")[0].InnerText; } }
        ...
        public void GetVertexNormals() {
            for (int i = 0; i < TriMMApp.Mesh.Vertices.Count; i++) {
                ...
                for (int j = 0; j < vertex.Triangles.Count; j++) {
                    ...
                    double weight = 1 /
                        (Vector.Distance(TriMMApp.Mesh.Vertices[i], TriMMApp.Mesh.Vertices[neighbors[0]])
